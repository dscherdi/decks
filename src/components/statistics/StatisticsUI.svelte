<script lang="ts">
  ...
  function getDueToday() {
    ...
    logger.debug(`[StatisticsUI] Due today: ${dueToday}`, statistics?.forecast);
    return dueToday;
  }
    ...
    <div class="decks-stats">
        ...
        {:else}
          <div class="decks-no-data-message">
            ...
            <p class="decks-help-text">
              Start reviewing flashcards to see your daily statistics here!
            </p>
          </div>
        {/if}
      </div>
      ...
      <div class="decks-stats-section">
        ...
        <div class="decks-metrics-grid">
          ...
          <div class="decks-metric-card">
            <div class="decks-metric-value" style="display: none;">0</div>
            <div class="decks-metric-label" style="display: none;">
              Learning Cards
            </div>
            <div class="decks-metric-description" style="display: none;">
          ...
          <div class="decks-metric-card">
            ...
            <div class="decks-metric-description">All cards in collection</div>
          </div>
        </div>
