...
describe("Scheduler", () => {
    ...
    describe("rate", () => {
        ...
        it("should throw error when card not found", async () => {
            ...
            await expect(
                scheduler.rate("nonexistent_card", "good")
            ).rejects.toThrow("Card not found: nonexistent_card");
        });
    });
    ...
    describe("timeToNext", () => {
        ...
        describe("Review Session Management", () => {
            beforeEach(() => {
                ...
                mockDb.createReviewSession = jest
                    .fn()
                ...
                mockDb.getActiveReviewSession = jest
                    .fn()
                    .mockResolvedValue(null);
                mockDb.updateReviewSessionDoneUnique = jest
                    .fn()
                    .mockResolvedValue(undefined);
                mockDb.endReviewSession = jest
                    .fn()
                    .mockResolvedValue(undefined);
            ...
            test("should track unique card reviews in session", async () => {
                ...
                expect(
                    mockDb.updateReviewSessionDoneUnique
                ).toHaveBeenCalledWith("session_123", 1);
